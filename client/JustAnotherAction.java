...
public class JustAnotherAction {
    ...
    private JustAnotherAction(XSAce ace, String pathToServer){
        ...
        //ace.runNLCommand("ls", "/");// testing purpose
        ...
        Thread backgroundRun = new Thread(new Runnable() {
            ...
            protected void finalize() throws Throwable {
                System.out.println("Calling JAC finalize");
                super.finalize();
            }
        });
        ...
        synchronized (mutex){
            try {
                ...
                || ((StatusInfo)callback.getLastResult()).getCode() != XSACEConsts.Commands.FINISHED)
                    //System.out.println("Locking constructor until response is ready...");
                    mutex.wait();
                    //System.out.println("Releasing constructor because response is ready...");
        ...
        //System.out.println("Just Another Action ready..."); // Testing purpose
    }
...
abstract class JustAnotherBase{
    ...
    protected static final Object stepMutex = new Object();
    ...
    // For private use only (This class and subclasses)
    protected String translate(String builder){
        ...
        return this.callback.retrieveFromPocket().strip();
    }
    // Common
